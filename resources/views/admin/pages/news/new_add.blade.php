...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="container" id="kt_content_container">
		...
		<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0"
			...
			<!--begin::Heading-->
			<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Add New New</h1>
			<!--end::Heading-->
			<!--begin::Breadcrumb-->
			<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
				...
				<li class="breadcrumb-item text-dark">New Add</li>
			</ul>
			<!--end::Breadcrumb-->
		</div>
		<!--begin::Card-->
			...
			<div class="card-body pt-0">
				...
				<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
					<div class="table-responsive">
						...
						<br>
						<div>
							<span class="fs-2x fw-bolder text-gray-800">Form New</span>
						</div>
						...
						<form action="{{route('news.store')}}" method="post" enctype="multipart/form-data">
							...
							<div class="row gx-10 mb-5">
								...
								<div class="col-lg-6">
									...
									<!--end::Input group-->
									<!--begin::Input group-->
									{{-- <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">content</label>
															<div class="mb-5">
																<input type="text" class="form-control form-control-solid" placeholder="content"value="{{old('content')}}"
									name="content">
									@error('content')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								...
								<!--end::Input group-->
								<!--begin::Input group-->
								<label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Publishers</label>
								<div class="mb-5">
									<select id="inputState" class="form-control" style="padding: 10px;" name="user_id">
										<option value="">Select Publishers</option>
										@foreach($users as $user)
										<option value="{{$user->id}}" {{(old('institution_id')==$user->id)?
							...
							<!--begin::Col-->
							<div class="col-lg-6">
								<label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Publish Date</label>
								<!--begin::Input group-->
								<div class="mb-5">
									<input type="date" class="form-control form-control-solid"
										placeholder="publish_date" value="{{old('publish_date')}}" name="publish_date">
									@error('publish_date')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="col-12">
								...
								<textarea class="form-control" aria-label="With textarea" value="{{old('content')}}"
