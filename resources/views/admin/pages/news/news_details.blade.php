						...
						<form action="{{route('news.update',$new->id)}}" method="post" enctype="multipart/form-data">
							...
							<div class="row gx-10 mb-5">
								...
								<div class="mb-5">
                                    ...
                                    <option value="">Select Publishers</option>
										...
										<option value="{{$user->id}}" {{($new->user_id==$user->id)?
							...
							<div class="col-lg-6">
								...
								<div class="mb-5">
									<input type="date" class="form-control form-control-solid"
										placeholder="publish_date" value="{{$new->publish_date}}" name="publish_date">
									@error('publish_date')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="col-12">
								...
								<textarea class="form-control" aria-label="With textarea" 
									name="content" required />{{$new->content}}</textarea>
								@error('content')
								<div class="alert alert-danger">{{ $message }}</div>
								@enderror
							</div>
        ...
        {{--div for show photo --}}
						...
						<div class="col-xl-12 mb-30">
								<div class="card card-statistics h-100">
									...
									<img src="{{url('/data/news')}}/{{$new->main_img }}" class="w3-round" width="200px" alt="Norway">
									@else
