		...
		<div class="d-flex flex-stack">
			...
			<div class="ms-1">
				<div class="btn btn-sm btn-icon btn-active-color-primary position-relative me-n2"
					data-kt-menu-trigger="hover" data-kt-menu-placement="top-end" data-kt-menu-flip="bottom">
				...
				<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
					...
					<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end"
						data-kt-menu-flip="{default: 'bottom', lg: ''}">
					...
					<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end"
						data-kt-menu-flip="{default: 'top', lg: ''}">
						<a href="#" class="menu-link px-5">
							...
							<span
								...
								<img class="w-15px h-15px rounded-1 ms-2"
									src="{{asset('assets/media/flags/egypt.svg')}}" alt="" /></span></span>
							@endif
						</a>
						<!--begin::Menu sub-->
						<div class="menu-sub menu-sub-dropdown w-175px py-4">
					...
					<li class="nav-item"> <a class="menu-link d-flex px-5" hreflang="{{ $localeCode }}"
